...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__signup__ = __webpack_require__(877);
    ...
    SignupPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponenetsModule */], __WEBPACK_IMPORTED_MODULE_4_angularfire2_auth__["AngularFireAuthModule"]
            ],
        })
    ], SignupPageModule);
...
var SignupPage = /** @class */ (function () {
    function SignupPage(navCtrl, navParams, toastCntrl, alertCntrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.toastCntrl = toastCntrl;
        this.alertCntrl = alertCntrl;
    }
    SignupPage.prototype.register = function (event) {
        console.log(event);
        ...
        if (!event.error) {
            ...
            var alert_1 = this.alertCntrl.create({
                subTitle: 'Signup Failed!',
    ...
    SignupPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-signup',template:/*ion-inline-start:"H:\shareMyRide\src\pages\signup\signup.html"*/'<!--\n\n  Generated template for the SignupPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n\n\n\n\n  <ion-header no-shadow no-border>\n\n\n\n  <ion-navbar  transparent hideBackButton="true">\n\n  <ion-buttons left >\n\n		<button ion-button navPop icon-only style="font-size:20px" color="mycolor">\n\n			<ion-icon name="md-arrow-round-back"></ion-icon>\n\n		</button>\n\n	</ion-buttons>\n\n  \n\n</ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n\n\n<signupform (registerStatus)="register($event)"></signupform>\n\n\n\n\n\n</ion-content>\n\n<!-- <ion-footer  style="padding-bottom:10vh;text-align:center"> \n\n<div text-center >\n\n           <button type="submit" style="width:230px"class="loginbutton" ion-button color=mycolor round\n\n            (click)="onGoTo()"[disabled]="false">Create Account</button>\n\n   [disabled]="!signupform.valid" \n\n</div>\n\n</ion-footer>-->'/*ion-inline-end:"H:\shareMyRide\src\pages\signup\signup.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* ToastController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], SignupPage);
    return SignupPage;
}());
